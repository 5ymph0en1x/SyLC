...
from sylc import lavf_h264_demuxer as _lavf   # reutilise _load() + structures + offsets (DRY)
from sylc.lavf_h264_demuxer import AVRational, AVFormatContext, AVCodecParameters, AVPacket
