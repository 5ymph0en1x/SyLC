...
from sylc import lavf_h264_demuxer as _lavf          # _load() + DLL handles + ABI structs (DRY)
from sylc.lavf_h264_demuxer import AVFormatContext, AVCodecParameters, AVRational, AVPacket
